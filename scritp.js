...
document.addEventListener('DOMContentLoaded', () => {
    const items = [
        ...
        { id: 2, title: 'Aceite de coco', imgSrc: 'aceite.png', description: "Aceite de coco prensado en frío, precio: $28.000", pageUrl: 'aceite_de_coco.html' },
        { id: 3, title: 'Cremas extrahumectante', imgSrc: 'cremas.png', description: "Crema extrahumectante para el cuidado diario, precio: $48.000", pageUrl: 'cremas_extrahumectantes.html' },
